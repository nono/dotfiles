Links for things that can be useful in a CLAUDE.md file, or as a skill.

https://fabiensanglard.net/agent.md/index.html (be short for human consumption)
https://danluu.com/benchpocalypse/ (the holdout benchmark trick)
